...
$TCA["tx_mrastp_person"] = array (
	...
	"interface" => array (
		"showRecordFieldList" => "hidden,starttime,endtime,salutation_id,firstname,name,street,compl,zip,city,canton_id,country_id,phone,mobile,fax,email,language_id,section_id,status,entry_date,comments,workaddress,groups,feuser_id"
	),
	...
	"columns" => array (
        ...
        "comments" => Array (
            "exclude" => 1,
            "label" => "LLL:EXT:mr_astp/locallang_db.xml:tx_mrastp_person.comments",
            "config" => Array (
                "type" => "text",
                "cols" => "40",
                "rows" => "15"
	...
	"types" => array (
		"0" => array("showitem" => "hidden;;1;;1-1-1, salutation_id, firstname, name, street, compl, zip, city, canton_id, country_id, phone, mobile, fax, email, language_id, section_id, status, entry_date, comments, workaddress, groups, feuser_id")
	),
	"palettes" => array (
